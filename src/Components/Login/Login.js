        ...
        <div className='container my-5 p-2 border w-50 mx-auto'>
            <form onSubmit={handleSubmit}>
                ...
                <div class="form-group my-2">
                    ...
                    <input onBlur={emailSign} type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" required/>
                </div>
                <div class="form-group my-2">
                    <label for="exampleInputPassword1">Password</label>
                    <input onBlur={passwordSign} type="password" class="form-control" id="exampleInputPassword1" placeholder="Password" required/>
                </div>
            ...
            <button onClick={()=>signInWithGoogle()} className='btn btn-primary w-100'>Signin With Google</button>
